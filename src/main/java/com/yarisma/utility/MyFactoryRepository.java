...
public class MyFactoryRepository <T, ID> implements ICrud<T, ID>{
    ...
    public Optional<T> findById(ID id) {
        ...
        T t = entityManager.createQuery(criteria).getSingleResult();
    ...
    public boolean existById(ID id) {
        ...
        return !result.isEmpty();   //exist -> kayıt var mı? -- isEmpty -> bos mu
    ...
    public List<T> findByEntity(T entity) {
        ...
        try {
            ...
            System.out.println("beklenmeyen bir sorun olustu..." + exception.toString());
        }
